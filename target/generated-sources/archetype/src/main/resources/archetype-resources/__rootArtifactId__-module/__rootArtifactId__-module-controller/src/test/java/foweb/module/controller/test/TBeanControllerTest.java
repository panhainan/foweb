 ...
 * 
 */
package ${package}.foweb.module.controller.test;
...
import ${package}.test.module.common.BaseControlTest;
...
//		pageConfig.setPageIndex(3);
//		pageConfig.setPageSize(5);
//		String requestJsonStr = JSONObject.toJSONString(pageConfig);
		Integer pageSize = 5;
		Integer pageIndex = 3;
